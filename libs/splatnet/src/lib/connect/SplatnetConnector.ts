...
export class SplatnetConnector {
  ...
  private static readonly AUTHORIZE_URL = 'https://accounts.nintendo.com/connect/1.0.0/authorize';
  ...
  static generateAuthUrl(authCodeVerifier: string) {
    ...
    const authCodeChallenge = SplatnetConnector.toUrlSafeBase64Encode(authCvHash.digest());
  }
