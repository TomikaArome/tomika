...
export const isSessionTokenResponse = (obj): obj is SessionTokenResponse => typeof obj?.session_token === 'string' && typeof obj?.code === 'string';
...
export const isUserInfoForAuthResponse = (obj): obj is UserInfoForAuthResponse =>
...
export const isFTokenResponse = (obj): obj is FTokenResponse => typeof obj?.f === 'string' && typeof obj?.request_id === 'string' && typeof obj?.timestamp === 'number';

export interface AccessTokenResponse {
  accessToken: string;
  expiresIn: number;
}
export const isAccessTokenResponse = (obj): obj is AccessTokenResponse => typeof obj?.accessToken === 'string' && typeof obj?.expiresIn === 'number';
